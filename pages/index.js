...
export default function Home({ posts }) {
  ...
  return (
    <Container>
      <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16 font-normal">
        <h1 className="font-bold text-3xl md:text-5xl tracking-tight mb-4 text-black dark:text-white">
          Hey, I’m Felix Koppe
        </h1>
        <h2 className="prose font-normal text-gray-600 dark:text-gray-400 mb-16">
          I'm a technophile designer, developer and creator. You’ve found my personal slice of the internet – enjoy your time
          while you're here.
        </h2>
        <h1 className="font-bold text-3xl md:text-5xl tracking-tight mb-4 text-black dark:text-white">
          Blog
